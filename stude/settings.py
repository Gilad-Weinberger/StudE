...
SECRET_KEY = 'django-insecure-5d2qqi4s#gox^!x$v0rmodz#l&ehu4o$6v&s1&a8hu%cj%3mie'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [
    'stude-official.vercel.app',  # Your Vercel domain
    '127.0.0.1',                 # Localhost
...
WSGI_APPLICATION = 'stude.wsgi.application'
